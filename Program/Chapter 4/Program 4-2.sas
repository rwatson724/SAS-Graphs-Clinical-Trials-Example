/****************************************************************************************
Program:          Program 4-2.sas
SAS Version:      SAS 9.4M3
Developer:        Kriss Harris 
Date:             2020-08-06
Purpose:          Produce Step 2 of Napoleon Plot output for SAS® Graphics for Clinical Trials by Example book. 
Operating Sys:    Windows 7
Macros:           NONE
Input:            tfldata.napoleon_data1
Output:           Output 4-2.png
...
ods graphics on / reset = all imagename ="Output 4-2" height = 3.33in width = 5in ;
