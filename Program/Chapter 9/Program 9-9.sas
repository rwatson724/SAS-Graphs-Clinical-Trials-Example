/****************************************************************************************
Program:          Program 9-9.sas
SAS Version:      SAS 9.4M3
Developer:        Kriss Harris 
Date:             2020-18-07
Purpose:          Used to create the Survival plot using SGPLOT with a DPI of 300 for SAS® Graphics for Clinical Trials by Example book. 
Operating Sys:    Windows 7
Macros:           NONE
Input:            adam.adtteeff     
Output:           Output 9-5.png
...
ods graphics / reset = all imagename = "Display 9-5";
