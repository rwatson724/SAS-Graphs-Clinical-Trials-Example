...
* Using format;
proc format cntlin = tfldata.format_dataset_output_2_2;
run;
...
ods graphics / reset = all imagename = "Output 2-2" imagefmt = png height = 3.33in width = 5in;

proc sgrender data = tfldata.adaesummaryrel1 template = aedatapanelsoc;
