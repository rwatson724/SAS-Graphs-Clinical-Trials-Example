/****************************************************************************************
Program:          Program 2-6.sas
SAS Version:      SAS 9.4M3
Developer:        Kriss Harris 
Date:             2019-12-16
Purpose:          Create KM plot of Time-to First Dermatological Event (in Days) by Treatment: 
                  Doing modifications with GTL Template outputs for SAS® Graphics for Clinical Trials by Example book.
Operating Sys:    Windows 7
Macros:           %SurvivalTemplateRestore, %SurvivalTemplate
Input:            adam.adtte
Output:           Output 2-6.png
...
%include "C:\Users\gonza\Desktop\GTL_Book_with_Richann_Watson\Chapter 2\pg\macros\TEMPLFT2.sas";
...
ods graphics / reset=all imagename="Output 2-6" height=3.33in width=5in;
ods trace on;
